...
public class Arrow {
    ...
    public Arrow(double startX, double startY, double endX, double endY, String label, boolean existsSameTrans) {
        ...
        double distance = Math.sqrt(Math.pow(endLineX - startLineX, 2)) + Math.pow((endLineY - startLineY), 2);
    ...
    //Circle for loop
    public Arrow(double startX, double endX, String label) {

        loop = new Circle(radius - 5);
        loop.setCenterX(startX - 17);
        loop.setCenterY(endX - 17);
